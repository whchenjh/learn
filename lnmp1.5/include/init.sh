...
#    Download_Files ${Download_Mirror}/web/mhash/${Mhash_Ver}.tar.bz2 ${Mhash_Ver}.tar.bz2
    Download_Files http://lnmp.cjh.com/src/${Libiconv_Ver}.tar.gz ${Libiconv_Ver}.tar.gz
    Download_Files http://lnmp.cjh.com/src/${LibMcrypt_Ver}.tar.gz ${LibMcrypt_Ver}.tar.gz
    Download_Files http://lnmp.cjh.com/src/${Mcypt_Ver}.tar.gz ${Mcypt_Ver}.tar.gz
    Download_Files http://lnmp.cjh.com/src/${Mhash_Ver}.tar.bz2 ${Mhash_Ver}.tar.bz2
...
#        Download_Files ${Download_Mirror}/web/nginx/${Nginx_Ver}.tar.gz ${Nginx_Ver}.tar.gz
    Download_Files http://lnmp.cjh.com/src/${Nginx_Ver}.tar.gz ${Nginx_Ver}.tar.gz
    fi
    if [[ "${DBSelect}" =~ ^[12345]$ ]]; then
#        Download_Files ${Download_Mirror}/datebase/mysql/${Mysql_Ver}.tar.gz ${Mysql_Ver}.tar.gz
        Download_Files http://lnmp.cjh.com/src/${Mysql_Ver}.tar.gz ${Mysql_Ver}.tar.gz
...
#    Download_Files ${Download_Mirror}/web/php/${Php_Ver}.tar.bz2 ${Php_Ver}.tar.bz2
    Download_Files http://lnmp.cjh.com/src/${Php_Ver}.tar.bz2 ${Php_Ver}.tar.bz2
    if [ ${PHPSelect} = "1" ]; then
...
#    Download_Files ${Download_Mirror}/datebase/phpmyadmin/${PhpMyAdmin_Ver}.tar.xz ${PhpMyAdmin_Ver}.tar.xz
    Download_Files http://lnmp.cjh.com/src/${PhpMyAdmin_Ver}.tar.xz ${PhpMyAdmin_Ver}.tar.xz
#    Download_Files ${Download_Mirror}/prober/p.tar.gz p.tar.gz
    Download_Files http://lnmp.cjh.com/src/p.tar.gz p.tar.gz
    if [ "${Stack}" != "lnmp" ]; then
...
#    Download_Files ${Download_Mirror}/lib/openssl/${Openssl_Ver}.tar.gz ${Openssl_Ver}.tar.gz
    Download_Files http://lnmp.cjh.com/src/${Openssl_Ver}.tar.gz ${Openssl_Ver}.tar.gz
}
...
#        Download_Files ${Download_Mirror}/lib/freetype/${Freetype_Ver}.tar.bz2 ${Freetype_Ver}.tar.bz2
        Download_Files http://lnmp.cjh.com/src/${Freetype_Ver}.tar.bz2 ${Freetype_Ver}.tar.bz2
...
#        Download_Files ${Download_Mirror}/web/pcre/${Pcre_Ver}.tar.bz2 ${Pcre_Ver}.tar.bz2
        Download_Files http://lnmp.cjh.com/src/${Pcre_Ver}.tar.bz2 ${Pcre_Ver}.tar.bz2
...
#        Download_Files ${Download_Mirror}/lib/boost/${Boost_Ver}.tar.bz2 ${Boost_Ver}.tar.bz2
        Download_Files http://lnmp.cjh.com/src/${Boost_Ver}.tar.bz2 ${Boost_Ver}.tar.bz2
